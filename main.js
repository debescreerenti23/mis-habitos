    ...
    function nuevaFrase() {
        ...
        document.getElementById('frase-motivadora').innerText = "“" + frases[index] + "”";
    }
    ...
    function actualizarBarra() {
        const checks = document.querySelectorAll('input[type="checkbox"]');
        const marcados = Array.from(checks).filter(c => c.checked).length;
        document.getElementById('barra-progreso').style.width = checks.length === 0 ? "0%" : (marcados/checks.length*100) + "%";
    }
